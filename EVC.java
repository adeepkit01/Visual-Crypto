	...
	public class EVC {
	    ...
	    public static void 	main(String args[])throws IOException
	    {
               ...
               for (int j = 0; j < w; j++)
	        {
	            for (int k = 0; k < h; k++)
	            {
                        img1.setRGB((2*j+1),(2*k+1), im1.getRGB(j,k));
                        img1.setRGB((2*j),(2*k+1), im1.getRGB(j,k));
                        img1.setRGB((2*j+1),(2*k), im1.getRGB(j,k));
                        img1.setRGB((2*j),(2*k), im1.getRGB(j,k));
                        img2.setRGB((2*j+1),(2*k+1), im2.getRGB(j,k));
                        img2.setRGB((2*j),(2*k+1), im2.getRGB(j,k));
                        img2.setRGB((2*j+1),(2*k), im2.getRGB(j,k));
                        img2.setRGB((2*j),(2*k), im2.getRGB(j,k));
                    }
                  }
               for (int j = 0; j < w; j++)
	        {
	            for (int k = 0; k < h; k++)
	            {
                      ...
                      {
                          if(img1.getRGB(2*j,2*k)!=-16777216 && img2.getRGB(2*j,2*k)!=-16777216)
                          {
                     ...
                     {
                          if(img1.getRGB(2*j,2*k)!=-1)
                          {
                              img1.setRGB(2*j,2*k,-1);
                              img1.setRGB(2*j,2*k+1,-1);
                          }
                           if(img2.getRGB(2*j,2*k)!=-1)
                          {
	        ...
	        for (int j = 0; j < w; j++)
	        {
               ...
               File outputfile3 =  new   File ("EVCShare1"+"."+type);
	            ImageIO .write(img1,type,outputfile3);
               File outputfile4 =  new   File ("EVCShare2"+"."+type);
